...
namespace techtake
{
    public partial class frmAdicionarLegislacao : Form
    {
        BLL_Aula objAula = new BLL_Aula();
        public static double ValorAulaLegislativa = 30.00;

        public frmAdicionarLegislacao()
        {
            InitializeComponent();
            CarregarComboBox();
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                objAula.Valor = ValorAulaLegislativa;
                objAula.Tipo  = "L";

                objAula.Materia     = cbxMateria.Text;
                ...
                objAula.InserirAula();
                Program.Msg = "Aula legislativa, registrada com sucesso, o aluno está sendo aguardado no dia " + dtpData.Text + ", no horario de " + mskHora.Text + "!";
                Program.Sucesso();
                this.Close(); 
